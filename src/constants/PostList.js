const PostList = [
  ...
  },
 {
    ...
    category: "Green Economy",
    description: "Hace 5 años aproximadamente el fundador de Microsoft, Bill Gates, daba una charla sobre la próxima epidemia que viene dentro de las afamadas y popularizadas sesiones del " +
    "programa de “TedTalk”. En ella resumía de manera ágil y clara la importancia de anticiparnos a los cambios que vendrían...",
    date: "03-05-20",
    views: "1"
},
{
...
},
{
    ...
    description: "Imaginemos por un momento que volvemos a estar frente a nuestro profesor de matemáticas de secundaria, para algunos de nosotr@s lo que era 5º o 6º de EGB, y que esté nos pide dibujar " +
    "un triángulo con una área determinada sin ningún otro requisito u objetivo.",
    date: "8-07-19",
    views: "24"
}
